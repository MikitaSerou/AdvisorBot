...
<head>
    ...
    <title><spring:message code="edit.city"/></title>
        ...
        <div class="row">
            ...
            <form id="city_form" action="${pageContext.request.contextPath}/city/edit/${city.id}" method="post">
                ...
                <select name="countryId" class="form-select" aria-label="Default select example">
                    <option selected name="countryId" value=${country.id}>${city.country.name}</option>
                    <c:forEach items="${countries}" var="country">
                        <c:if test="${!city.country.equals(country)}">
                            <option name="countryId" value=${country.id}>${country.name}</option>
                        </c:if>
                    </c:forEach>
                </select>
                <br/>
                ...
                <c:if test="${city.isCapital}">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="isCapital" value="true"
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="isCapital" value="false"
                ...
                <br/>
                <h4 id="description"><spring:message code="new.description"/>:</h4>
