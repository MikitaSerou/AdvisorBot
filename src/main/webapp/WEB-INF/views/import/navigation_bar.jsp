...
<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
    ...
    <div class="btn-group btn-group-sm" role="group" aria-label="..." style="position: absolute; right: 25px;">
        <a href="${pageContext.request.contextPath}/city/new">
        ...
        <a href="${pageContext.request.contextPath}/country/new">
            <button type="button" class="btn btn-success">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-plus"
                     viewBox="0 0 16 16">
                    <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1
